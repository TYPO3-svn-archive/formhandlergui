 ...
 * @version $Id$
 */
class Tx_FormhandlerGui_TextArea extends Tx_FormhandlerGui_ActionController {
	...
	public function indexAction() {
		...
		if (!empty($fieldConf->cssClass)) {
			$params .= ' class="'.$fieldConf->cssClass.'"';
		}
		if (!empty($fieldConf->rows)) {
			$params .= ' rows="'.$fieldConf->rows.'"';
		}
		if (!empty($fieldConf->cols)) {
			$params .= ' cols="'.$fieldConf->cols.'"';
		}
